@echo off
:: FDLTCC Imaging Script - runs from \\10.1.4.245\pxeimaging\
...
set INSTALL_WIM=\\10.1.4.245\pximages\install.wim

:: Verify image exists
if not exist %INSTALL_WIM% (
    echo ERROR: install.wim not found at %INSTALL_WIM%
    echo Please copy a Windows 11 Pro install.wim to \\10.1.4.245\pximages\
    pause
    exit /b 1
)
...
copy /Y %SHARE%\post-install.ps1 W:\Windows\Setup\Scripts\post-install.ps1
copy /Y %SHARE%\autounattend.xml W:\unattend.xml
